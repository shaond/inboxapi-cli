...
/// Build the arguments JSON for account_recover from CLI args.
...
mod tests {
    ...
    fn test_verify_owner_accepts_owner_email_flag() {
        ...
        match cli.command {
            ...
            _ => panic!("expected VerifyOwner command"),
        }
    }
    ...
    #[test]
    fn test_account_recover_accepts_api_named_flags() {
        let cli = Cli::try_parse_from([
            "inboxapi",
            "account-recover",
            "--account-name",
        ...
        match cli.command {
            ...
            _ => panic!("expected AccountRecover command"),
        }
    }

    #[test]
    fn test_account_recover_args_use_api_field_names() {
        let args = build_account_recover_args("test-account", "owner@example.com", Some("123456"))
            .unwrap();
    ...
    fn test_account_recover_rejects_invalid_code() {
        let err = build_account_recover_args("test-account", "owner@example.com", Some("12345x"))
            .unwrap_err();
